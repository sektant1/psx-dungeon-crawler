...
glm::mat4 trsBake(glm::quat q, glm::vec3 s) {
  return glm::mat4_cast(q) * glm::scale(glm::mat4(1.0f), s);
}
...
int main(int, char **) {
  ...
  // world_env.tres
  r.setAmbient(
      {lin(1.0f) * 0.15f, lin(0.67451f) * 0.15f, lin(0.988235f) * 0.15f});
  ...
  // --------------------------------------------------------- LightShaft ---
  r.attachMesh(r.createNode(eng::kRootNode, {0.0109267f, 2.05731f, 0.0147681f}),
  ...
  {
    eng::NodeHandle base = r.createNode(eng::kRootNode, {-1.0f, 2.236f, 0.0f});
  ...
  for (bool reverse : {false, true}) {
    eng::NodeHandle base =
        r.createNode(eng::kRootNode, {reverse ? 1.0f : -1.0f, 0.0f, 0.0f});
  ...
  const CrystalXf crystals[5] = {
      {0.719146f, 0, 0.694859f, 0, 1, 0, -0.694859f, 0, 0.719146f, 1.93081f, 0,
       1.34372f},
      {0.826285f, 0, -0.563252f, 0, 1, 0, 0.563252f, 0, 0.826285f, -1.32247f, 0,
       1.77809f},
      {0.864371f, 0, 0.502854f, 0, 1, 0, -0.502854f, 0, 0.864371f, -2.32825f, 0,
       -0.999177f},
      {-0.632935f, 0, 0.774205f, 0, 1, 0, -0.774205f, 0, -0.632935f, 2.30476f,
       0, -1.16371f},
      {-0.90227f, 0, -0.431172f, 0, 1, 0, 0.431172f, 0, -0.90227f, -0.00271803f,
       0, -1.98459f},
  };
  for (const CrystalXf &x : crystals) {
    eng::NodeHandle root = r.createNode(eng::kRootNode, {x.ox, x.oy, x.oz});
    r.setOrientation(root, eng::quatFromBasisRows(x.a, x.b, x.c, x.d, x.e, x.f,
                                                  x.g, x.h, x.i));
